...
local function oftenUsed()
    return {
        ...
        {line = ' Timeliste', cmd = 'edit $HOME/Documents/School/GRUPPELÆRER/IN2010_2021/timeliste-oktober.norg'},
...
vim.g.startify_lists = {
    ...
    { type = configFiles, header = {'   Config files'}, indices = {'cv', 'cb', 'ca', 'ci', 'cr', 'ck', 'cp', 'co', 'cz'}},
