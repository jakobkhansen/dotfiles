# Generated by Powerlevel10k configuration wizard on 2021-10-17 at 20:58 CEST.
...
() {
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=""
    (( VCS_STATUS_PUSH_COMMITS_AHEAD && !VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" "
    # ⇢42 if ahead of the push remote; no leading space if also behind: ⇠42⇢42.
    (( VCS_STATUS_PUSH_COMMITS_AHEAD  )) && res+=""
    # *42 if have stashes.
    (( VCS_STATUS_STASHES        )) && res+=""
    # 'merge' if the repo is in an unusual state.
    [[ -n $VCS_STATUS_ACTION     ]] && res+=""
    # ~42 if have merge conflicts.
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=""
    # +42 if have staged changes.
    (( VCS_STATUS_NUM_STAGED     )) && res+=""
